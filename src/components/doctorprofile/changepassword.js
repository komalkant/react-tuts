                ...
                <form onSubmit={this.handleSubmit} className="change-setting" >
                    <div className="row">
                        ...
                        <div className="col-md-4 user-form-setting-cols">
                            ...
                            <div style={{ position: "absolute", top: "33%", userSelect: "none", right: lang == "ar" ? "229px" : "0px", marginTop: "-2.5px" }}>{this.state.showpass1 ? <i className="fa fa-eye-slash" onClick={() => { this.setState({ showpass1: false }) }} aria-hidden="true"></i> : <i className="fa fa-eye" onClick={() => { this.setState({ showpass1: true }) }} aria-hidden="true"></i>}</div>
                        </div>
                        <div className="col-md-4 user-form-setting-cols">
                            ...
                            <div style={{ position: "absolute", top: "33%", userSelect: "none", right: lang == "ar" ? "229px" : "0px", marginTop: "-2.5px" }}>{this.state.showpass2 ? <i className="fa fa-eye-slash" onClick={() => { this.setState({ showpass2: false }) }} aria-hidden="true"></i> : <i className="fa fa-eye" onClick={() => { this.setState({ showpass2: true }) }} aria-hidden="true"></i>}</div>
                        ...
                        <div className="col-md-4 user-form-setting-cols">
                            ...
                            <div style={{ position: "absolute", top: "33%", userSelect: "none", right: lang == "ar" ? "229px" : "0px", marginTop: "-2.5px" }}>{this.state.showpass3 ? <i className="fa fa-eye-slash" onClick={() => { this.setState({ showpass3: false }) }} aria-hidden="true"></i> : <i className="fa fa-eye" onClick={() => { this.setState({ showpass3: true }) }} aria-hidden="true"></i>}</div>
                        </div>
                    </div>
                </form>
                {/* <!-- loader--> */}
