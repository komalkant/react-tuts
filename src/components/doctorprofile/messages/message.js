...
class Message extends Component {
                ...
                <div className="col-md-12 col-sm-12 col-xs-12 apoimtfiltrrqsr">
                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div className="col-md-4 col-sm-4 col-xs-12 appointreqstfrm">
                            ...
                            <div className="input-group-btn">
                                <button className="btn btn-default" onClick={() => { document.getElementById('datepicker').click() }} ><i className="fa fa-calendar"></i></button>
                            </div>
                        </div>
    ...
    messagein = () => {
        return (
            <div className="col-md-9 col-sm-8 col-xs-12 aponireqst messageinner">
