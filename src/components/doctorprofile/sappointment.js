...
class Sappointment extends Component {
    state = {
        startDate: "",
        name: "",
        popup: false,
    ...
    reject = (item) => {
        // console.log("item no", item.appointment_id)
        this.props.appointmentstatuschange({ id: item.appointment_id, appointment_completed: 0 })
    }
    ...
    list = () => {
        return this.props.appoints.map((item, index) => {
            ...
            // onClick={() => { this.setState({ user: item, popup: true }) }}
            if (item.is_booked == 1) {
                return (
                    <div className="col-md-12 col-sm-12 col-xs-12  appointcontmain" >
                        <div className="col-md-4 col-sm-4 col-xs-12 patientsecmain">
                            ...
                            <div className="col-md-10 col-sm-10 col-xs-8 patienttxt">
                                <h4>Patient Name</h4>
                                <p>Mr. {item.ufirst_name} {item.ulast_name}</p>
                            </div>
                        </div>
                        ...
                        <div className="col-md-12 col-sm-12 col-xs-12" >
                            ...
                            <button className="btn btn-danger" style={{ float: "right" }} onClick={this.reject.bind(this, item)}>reject</button>
                        </div>
                    </div>
                )
            }
